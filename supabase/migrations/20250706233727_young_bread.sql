/*
  # Add Live Mode Support for Stripe Webhooks

  1. Changes
    - Add STRIPE_LIVE_WEBHOOK_SECRET environment variable support
    - Create payment_logs table for detailed payment tracking
    - Add live_mode flag to payments table
    - Add webhook_event_id for idempotency
*/
...
-- Create payment_logs table for detailed payment logging if it doesn't exist
