        ...
        <div className="bg-slate-800 rounded-xl border border-slate-700 p-8 shadow-lg">
          <div className="space-y-6 text-slate-200 leading-relaxed">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-slate-100 mb-2 mt-4">4.1 Subscription Plans</h3>
              <p className="mb-3">
              ...
              <h3 className="text-xl font-semibold text-slate-100 mb-2 mt-4">4.2 Free Trial</h3>
              <p className="mb-3">
              ...
              <h3 className="text-xl font-semibold text-slate-100 mb-2 mt-4">4.3 Payment</h3>
              <p className="mb-3">
              ...
              <h3 className="text-xl font-semibold text-slate-100 mb-2 mt-4">4.4 Automatic Renewal</h3>
              <p className="mb-3">
              ...
              <h3 className="text-xl font-semibold text-slate-100 mb-2 mt-4">4.5 Refunds</h3>
              <p>
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-slate-100 mb-2 mt-4">6.1 Our Intellectual Property</h3>
              <p className="mb-3">
              ...
              <h3 className="text-xl font-semibold text-slate-100 mb-2 mt-4">6.2 License to Use</h3>
              <p className="mb-3">
              ...
              <h3 className="text-xl font-semibold text-slate-100 mb-2 mt-4">6.3 User Content</h3>
              <p>
