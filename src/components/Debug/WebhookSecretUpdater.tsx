  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-4 left-56 bg-purple-600 text-white rounded-lg px-4 py-2 flex items-center space-x-2 shadow-lg hover:bg-purple-700 transition-colors z-50"
      >
