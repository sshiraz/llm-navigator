...
interface AuthPageProps {
  ...
  confirmationLinkError?: string | null;
  onLinkErrorAcknowledged?: () => void;
}
...
export default function AuthPage({ onLogin, emailJustConfirmed, onConfirmationAcknowledged, confirmationLinkError, onLinkErrorAcknowledged }: AuthPageProps) {
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
            <div className="flex items-start justify-between">
              <div className="flex items-start space-x-2 text-amber-800">
                ...
                <span className="font-medium">{confirmationLinkError}</span>
              </div>
