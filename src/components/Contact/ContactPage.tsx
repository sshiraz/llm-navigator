...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-900">
      {/* Header */}
      <div className="bg-gradient-to-r from-blue-900 to-indigo-900 text-white py-16 border-b border-slate-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <button
            onClick={goBack}
            className="inline-flex items-center space-x-2 text-blue-300 hover:text-white mb-6 transition-colors"
          >
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 mt-1">Our team will respond within 3 business days</p>
                    <a href="mailto:info@convologix.com" className="text-blue-400 hover:text-blue-300 font-medium mt-1 block">
                      info@convologix.com
                    </a>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-center">
                    ...
                    <label htmlFor="privacy" className="ml-2 block text-sm text-slate-400">
                      I agree to the <a href="#privacy" onClick={(e) => {e.preventDefault(); window.location.hash = '#privacy'; window.location.reload();}} className="text-blue-400 hover:text-blue-300">Privacy Policy</a> and <a href="#terms" onClick={(e) => {e.preventDefault(); window.location.hash = '#terms'; window.location.reload();}} className="text-blue-400 hover:text-blue-300">Terms of Service</a>, and consent to being contacted.
                    </label>
                  </div>
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-slate-800 rounded-xl shadow-sm p-6 border border-slate-700">
              <h3 className="text-lg font-semibold text-white mb-3">What is LLM Navigator?</h3>
